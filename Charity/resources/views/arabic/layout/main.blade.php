    ...
    <header class="default-header">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                <!-- =============================== BASE  ======================================== -->
                @foreach(Menuarabics() as $Menu)
                <li><a href="{!! $Menu->url !!}" target="{!! $Menu->target !!}">{!! $Menu->title !!}</a></li>
                @endforeach
                </ul>
                @guest
                <!-- =============================== BASE ======================================== -->
                <a href="{{ route('login') }}" class="genric-btn primary small"><i class=" icon-material-outline-face"></i> {{ __('تسجيل الدخول') }}</a>
                @else
                <a href="{{ route('logout') }}" onclick="event.preventDefault();
                document.getElementById('logout-form').submit();" class="genric-btn primary small"><i class="icon-feather-log-in"></i> {{ __('الخروج') }}</a>
            ...
            <div class="row section_gap">
                <div class="col-lg-5 col-md-6 col-sm-6">
                    <div class="single-footer-widget tp_widgets">
                        ...
                        <p>
                          حقوق الطبع والنشر & &copy;كل الحقوق محفوظة   <a href="{{ url('/') }}" target="_blank">{{ Setting()->SiteTitle }}</a>
                      </p>
                      <!-- =============================== Setting BASE ======================================== -->
                  </div>
              </div>
