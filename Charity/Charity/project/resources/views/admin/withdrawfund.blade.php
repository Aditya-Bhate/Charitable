                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    <div class="add-product-header">
                                        ...
                                        <a href="{!! url('admin/campaign/'.$campaign->id) !!}" class="add-back-btn"><i class="fa fa-arrow-left"></i> Back</a>
                                    </div>
                                    <hr/>
                                    ...
                                    <form method="POST" action="{!! action('CampaignController@withdraws',['id'=> $campaign->id]) !!}" class="form-horizontal">
                                        {{csrf_field()}}
