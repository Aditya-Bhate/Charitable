                                ...
                                @else
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slug">Redirect URL <span class="required">*</span>
                                            <p class="small-label">e.g. http://vitproject.com</p>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" value="{{$ad->redirect_url}}" name="redirect_url" placeholder="e.g. http://vitproject.com" required="required" type="text">
                                        </div>
                                    </div>
                                @endif
                            </div>
