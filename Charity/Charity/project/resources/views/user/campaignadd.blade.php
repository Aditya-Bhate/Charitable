                                ...
                                <div class="add-product-box">                                                                
                                    ...
                                    <form method="POST" action="{!! action('UserCampaignController@store') !!}" id="add_form" class="form-horizontal"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="update_select_campaign_category" id="update_select_campaign_category" required>
                                        ...
                                        <div class="add-product-footer">                                            
                                                <button name="addProduct_btn" type="submit" class="btn btn-success add-product_btn">Create Campaign</button>                                            
                                        </div>
                                    </form>
                                </div>
                            </div>
